...
import SidebarLink from "@/components/BusinessDocs/termsOfServiceBarLink";
import {Metadata} from "next";

export const metadata: Metadata = {
    title: "Logit Transporters | Terms of Service",
                                ...
                                <form action={""}
                                    ...
                                    <div className="flex flex-wrap xl:justify-between ">
                                        <div className="flex mb-4 md:mb-0">
                                            ...
                                            >
                                                By clicking Checkbox, you agree to use our terms of service
                                                And consent cookie usage in browser. For more information please visit our privacy policy
                                            </label>
                                        </div>
