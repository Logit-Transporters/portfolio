...
const featuresTabData: FeatureTab[] = [
  {
    ...
    This service is not limited to businesses, we also deliver to individuals.
    This services is pay as you go,  you only pay for the packages you deliver, there is no monthly subscription fee.`,
  ...
  },
  {
    id: "tabTwo",
    title: "Fulfillment",
    desc1: `Fulfillment service is one where we store your products in our warehouse, we pick, pack and ship your products to your customers when they place an order.
  ...
  },
  {
    ...
    This service is includes some partially enabled functions for tier 1 and tier 2, and fully enabled functions for tier 3 and tier 4.
    We have integrated with the customers offices of the countries we operate in, to make the process of clearing your goods from the port easy and fast.
    we have added integration with multi-national shipping companies like Maersk, MSC, CMA CGM, Hapag-Lloyd, COSCO, 
    ONE, Evergreen, HMM, Yang Ming, PIL, ZIM, MOL, Wan Hai, OOCL, APL, and HMM. to make the process of clearing your goods from the port easy and fast.`,
    desc2: `we have included the feature that enables you to develop a digital supply chain, where you can track your goods from the port to your warehouse.
    with your dealer from the country you are importing from
    This service is enabled for all enterprise businesses that import goods from other countries, and has additional monthly subscription fee. for the subscription fee, 
    you get a dedicated account manager who will help you manage your inventory and orders.
    with this service the whole process visibility available to you, through our system portal and a dedicated expert to engage with you.
    `,
    image: "/images/features/features-light-01.svg",
    imageDark: "/images/features/features-dark-01.svg",
  }
